...
export const Comp: MapDef = {
    ...
    lootTable: {
        ...
        tier_surviv: [
            ...
            { name: "tier_medical", count: 1, weight: 0.25 }, // ? 31%
        ...
        tier_container: [
            ...
            { name: "tier_medical", count: 1, weight: 0.25 }, // 20
            { name: "tier_throwables", count: 1, weight: 0.05 }, // 5
        ...
        tier_armor: [
            ...
            { name: "helmet02", count: 1, weight: 11 },
        ...
        tier_scrap: [
            { name: "construction_item", count: 1, weight: 0.5 },
            { name: "construction_item", count: 2, weight: 0.5 },
        ],
        tier_ammo_crate: [
        ...
        tier_chest: [
            ...
            { name: "dp28", count: 1, weight: 0.3 },
            { name: "p90", count: 1, weight: 0.3 },
            { name: "m39", count: 1, weight: 0.3 },
            { name: "groza", count: 1, weight: 0.3 },
            { name: "saiga", count: 1, weight: 0.3165 },
        ...
        tier_grey_crate: [
            { name: "tier_weaker_lmgs", count: 1, weight: 0.33 }, // ?
            { name: "", count: 1, weight: 0.66 },
        ],
        tier_hawk: [
        ...
        tier_chest_ar: [
            ...
            { name: "mk12", count: 1, weight: 0.35 },
            { name: "m249", count: 1, weight: 0.12 },
            { name: "scar", count: 1, weight: 0.27 },
            { name: "p90", count: 1, weight: 0.4 },
            { name: "dp28", count: 1, weight: 0.32 },
            { name: "m39", count: 1, weight: 0.33 },
            { name: "spas12", count: 1, weight: 0.25 },
            { name: "saiga", count: 1, weight: 0.25 },
