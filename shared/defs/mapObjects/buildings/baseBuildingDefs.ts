...
export function createBankVault(
    overrides: DeepPartial<BuildingDef>,
    params: {
        gold_box?: number;
        ...
        mapObjects: [
            ...
            },
            {
                type: randomObstacleType({
                    deposit_box_01: 3,
                    deposit_box_02: params.gold_box || 1,
                }),
            ...
            {
                type: params.floor_loot || randomObstacleType({ loot_tier_vault_floor: 1 }),
                pos: v2.create(-3.5, 0),
                scale: 1,
                ori: 0,
            },
...
export function createBarn(
    overrides: DeepPartial<BuildingDef>,
    params: {
        bonus_room?: BuildingChildObjType;
        bonus_door?: BuildingChildObjType;
        porch_01?: BuildingChildObjType;
    },
): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
        ...
        mapObjects: [
            ...
            {
                type: params.bonus_room || "panicroom_01",
...
export function createBarnBasement(params: {
    basement?: BuildingChildObjType;
}): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
        map: { display: false, color: 0x665a4e, scale: 1 },
        ...
        mapObjects: [
            ...
            {
                type: params.basement || "barn_basement_floor_02",
                pos: v2.create(-8, 0),
                scale: 1,
                ori: 0,
            },
...
export function createBridgeLarge(overrides: DeepPartial<BuildingDef>): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
        map: {
            display: true,
...
function createBridgeXlarge(overrides: DeepPartial<BuildingDef>): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
        map: {
            display: true,
...
export function createContainer(props: {
    tint?: number;
    loot_spawner_01?: BuildingChildObjType;
    loot_spawner_02?: BuildingChildObjType;
    mapTint?: number;
    ...
    return {
        ...
        mapObjects: props.open ? openWalls : closedWalls,
    };
}
...
export function createCabin(
    overrides: DeepPartial<BuildingDef>,
    params: {
        cabin_wall_int_5?: BuildingChildObjType;
        cabin_wall_int_10?: BuildingChildObjType;
        cabin_wall_int_13?: BuildingChildObjType;
        cabin_mount?: BuildingChildObjType;
        porch_01?: BuildingChildObjType;
    },
): BuildingDef {
    const baseDef: BuildingDef = {
        ...
        mapObjects: [
            ...
            {
                type: params.cabin_wall_int_5 || "cabin_wall_int_5",
                pos: v2.create(-10.5, 9),
                scale: 1,
                ori: 0,
            },
            {
                type: params.cabin_wall_int_10 || "cabin_wall_int_10",
                pos: v2.create(-13, 2),
                scale: 1,
                ori: 1,
            },
            {
                type: params.cabin_wall_int_13 || "cabin_wall_int_13",
                pos: v2.create(-3.5, -4),
                scale: 1,
                ori: 0,
            },
...
function createClub(overrides: DeepPartial<BuildingDef>): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
        map: {
            display: true,
...
function createBathhouse(overrides: DeepPartial<BuildingDef>): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
        map: { display: false },
        terrain: { grass: true, beach: false },
...
function createBathhouseSideroom01(overrides: DeepPartial<BuildingDef>): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
...
function createBathhouseSideroom02(overrides: DeepPartial<BuildingDef>): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
        map: { display: true, shapes: [] },
        terrain: { grass: true, beach: false },
...
export function createHut(
    overrides: DeepPartial<BuildingDef>,
    params: {
        specialLoot?: BuildingChildObjType;
        ceilingImg?: string;
    },
): BuildingDef {
    const baseDef: BuildingDef = {
        ...
        ceiling: {
            ...
            imgs: [
                {
                    sprite: params.ceilingImg || "map-building-hut-ceiling-01.img",
                    scale: 0.667,
                    alpha: 1,
                    tint: 0xffffff,
                },
        ...
        mapObjects: [
            ...
            {
                type: params.specialLoot || "pot_01",
                pos: v2.create(0, 0),
                scale: 1,
                ori: 0,
            },
...
export function createGreenhouse(
    overrides: DeepPartial<BuildingDef>,
    params: {
        floor_images?: BuildingDef["floor"]["imgs"];
        ceiling_images?: BuildingDef["ceiling"]["imgs"];
    },
): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
...
export function createMansion(
    overrides: DeepPartial<BuildingDef>,
    params: {
        mansion_wall_int_1?: BuildingChildObjType;
        mansion_wall_int_5?: BuildingChildObjType;
        mansion_wall_int_6?: BuildingChildObjType;
        mansion_wall_int_7?: BuildingChildObjType;
        mansion_wall_int_8?: BuildingChildObjType;
        mansion_wall_int_9?: BuildingChildObjType;
        mansion_wall_int_10?: BuildingChildObjType;
        mansion_wall_int_11?: BuildingChildObjType;
        mansion_wall_int_12?: BuildingChildObjType;
        mansion_wall_int_13?: BuildingChildObjType;
        mansion_column_1?: BuildingChildObjType;
        bush?: BuildingChildObjType;
        bush_chance?: number;
        decoration_01?: BuildingChildObjType;
        decoration_02?: BuildingChildObjType;
        entry_loot?: BuildingChildObjType;
        porch_01?: BuildingChildObjType;
        tree?: BuildingChildObjType;
        tree_loot?: BuildingChildObjType;
        tree_scale?: number;
    },
): BuildingDef {
    const baseDef: BuildingDef = {
        ...
        mapObjects: [
            ...
            {
                type: params.mansion_column_1 || "mansion_column_1",
                pos: v2.create(-5, -24),
                scale: 1,
                ori: 1,
            },
            ...
            {
                type: params.mansion_wall_int_12 || "mansion_wall_int_12",
            ...
            {
                type: params.mansion_wall_int_1 || "mansion_wall_int_1",
            ...
            {
                type: params.mansion_wall_int_13 || "mansion_wall_int_13",
                pos: v2.create(-20.5, 5.5),
                scale: 1,
                ori: 1,
            },
            {
                type: params.mansion_wall_int_7 || "mansion_wall_int_7",
            ...
            {
                type: params.mansion_wall_int_6 || "mansion_wall_int_6",
            ...
            {
                type: params.mansion_wall_int_10 || "mansion_wall_int_10",
                pos: v2.create(-10, -8.5),
                scale: 1,
                ori: 1,
            },
            {
                type: params.mansion_wall_int_11 || "mansion_wall_int_11",
            ...
            {
                type: params.mansion_wall_int_9 || "mansion_wall_int_9",
            ...
            {
                type: params.mansion_wall_int_8 || "mansion_wall_int_8",
            ...
            {
                type: params.mansion_wall_int_5 || "mansion_wall_int_5",
                pos: v2.create(19.5, 1.5),
                scale: 1,
                ori: 0,
            },
            ...
            {
                type: params.entry_loot || "",
                pos: v2.create(-2, -8.5),
                scale: 1,
                ori: 0,
            },
            {
                type: params.decoration_02 || "loot_tier_mansion_floor",
                pos: v2.create(-2, -8.5),
                scale: 1,
                ori: 0,
            },
            {
                type: params.decoration_02 || "",
            ...
            {
                type: params.tree || "tree_interior_01",
                pos: v2.create(-2, 4),
                scale: params.tree_scale || 0.6,
                ori: 0,
                ignoreMapSpawnReplacement: true,
            },
            {
                type: params.tree_loot || "",
...
export function createMansionCellar(
    overrides: DeepPartial<BuildingDef>,
    params: {
        mansion_column_1?: BuildingChildObjType;
        mid_obs_01?: BuildingChildObjType;
        decoration_01?: BuildingChildObjType;
        decoration_02?: BuildingChildObjType;
    },
): BuildingDef {
    const baseDef: BuildingDef = {
        ...
        mapObjects: [
            ...
            {
                type: params.mid_obs_01 || "barrel_02",
...
export function createOutHouse(
    ...
    const baseDef: BuildingDef = {
        ...
        mapObjects: [
            ...
            {
                type: params.obs || randomObstacleType({ toilet_01: 5, toilet_02: 1 }),
                pos: v2.create(0, 2),
                scale: 0.95,
                ori: 0,
            },
...
export function createTeahouse(
    overrides: DeepPartial<BuildingDef>,
    params: { ceilingImgs?: BuildingDef["ceiling"]["imgs"] },
): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
        map: {
...
export function createTeaHouseComplex(
    overrides: DeepPartial<BuildingDef>,
    params: {
        tea_house?: BuildingChildObjType;
    ...
    const baseDef: BuildingDef = {
        ...
        mapGroundPatches: [
            {
                ...
                color: params.grass_color || 0x5c910a,
                roughness: 0.05,
                offsetDist: 0.25,
            },
        ],
        ...
        mapObjects: [
            {
                type: params.tea_house || "teahouse_01",
                pos: v2.create(0, 0),
                scale: 1,
                ori: 0,
            },
            ...
            {
                type: params.tree_small || "tree_07sp",
                pos: v2.create(-3, 12),
                scale: 0.9,
                ori: 0,
            },
            ...
            {
                type: params.tree_large || randomObstacleType({ tree_08sp: 2, "": 1 }),
                pos: v2.create(-10, -13),
                scale: 1,
                ori: 0,
            },
...
export function createHouseRed(
    overrides: DeepPartial<BuildingDef>,
    params: {
        house_wall_int_9?: BuildingChildObjType;
        house_wall_int_5?: BuildingChildObjType;
        house_wall_int_8?: BuildingChildObjType;
        house_wall_int_4?: BuildingChildObjType;
        house_column_1?: BuildingChildObjType;
        stand?: BuildingChildObjType;
        plant?: BuildingChildObjType;
        plant_pos?: Vec2;
        porch_01?: BuildingChildObjType;
        plant_loot?: BuildingChildObjType;
    },
): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
        ...
        mapObjects: [
            ...
            {
                type: params.house_wall_int_9 || "house_wall_int_9",
                pos: v2.create(-9.5, -1),
                scale: 1,
                ori: 1,
            },
            {
                type: params.house_wall_int_5 || "house_wall_int_5",
                pos: v2.create(4.5, -6),
                scale: 1,
                ori: 0,
            },
            ...
            {
                type: params.house_wall_int_8 || "house_wall_int_8",
                pos: v2.create(5.5, 8.5),
                scale: 1,
                ori: 0,
            },
            {
                type: params.house_wall_int_4 || "house_wall_int_4",
                pos: v2.create(8, 7),
                scale: 1,
                ori: 1,
            },
            ...
            {
                type: params.house_column_1 || "house_column_1",
                pos: v2.create(6, 3.5),
                scale: 1,
                ori: 0,
            },
            ...
            {
                type: params.plant || "bush_02",
                pos: params.plant_pos || v2.create(-12, -10.5),
                scale: 1,
                ori: 0,
                ignoreMapSpawnReplacement: true,
            },
...
export function createHouseRed2(
    overrides: DeepPartial<BuildingDef>,
    params: {
        house_column_1?: BuildingChildObjType;
        house_wall_int_4?: BuildingChildObjType;
        house_wall_int_5?: BuildingChildObjType;
        house_wall_int_11?: BuildingChildObjType;
        house_wall_int_14?: BuildingChildObjType;
        stand?: BuildingChildObjType;
        porch_01?: BuildingChildObjType;
        plant?: BuildingChildObjType;
        plant_pos?: Vec2;
    ...
    const baseDef: BuildingDef = {
        ...
        mapObjects: [
            ...
            {
                type: params.house_wall_int_14 || "house_wall_int_14",
                pos: v2.create(-7, 3),
                scale: 1,
                ori: 1,
            },
            {
                type: params.house_wall_int_11 || "house_wall_int_11",
                pos: v2.create(-8.5, -2),
                scale: 1,
                ori: 1,
            },
            ...
            {
                type: params.plant || "bush_02",
                pos: params.plant_pos || v2.create(2, 10.5),
                scale: 1,
                ori: 0,
                ignoreMapSpawnReplacement: true,
            },
...
export function createShack3(overrides: DeepPartial<BuildingDef>): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
        map: {
            display: true,
...
export function createShack2(overrides: DeepPartial<BuildingDef>): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
...
export function createShack(overrides: DeepPartial<BuildingDef>): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
...
export function createWarehouse(
    overrides: DeepPartial<BuildingDef>,
    params: {
        topLeftObs?: BuildingChildObjType;
        topRightObs?: BuildingChildObjType;
        botRightObs?: BuildingChildObjType;
        decoration_01?: BuildingChildObjType;
    ...
    const baseDef: BuildingDef = {
        ...
        mapObjects: [
            ...
            {
                type: params.topLeftObs,
                pos: v2.create(-21.25, 8.75),
                scale: 1,
                ori: 0,
                inheritOri: false,
                ignoreMapSpawnReplacement: params.ignoreMapSpawnReplacement,
            },
            {
                type: "crate_04",
...
export function createWarehouse2(overrides: DeepPartial<BuildingDef>): BuildingDef {
    const baseDef: BuildingDef = {
        type: "building",
        map: {
            display: true,
...
export function createWarehouse3(
    overrides: DeepPartial<BuildingDef>,
    params: {
        specialLoot?: BuildingChildObjType;
    ...
    const baseDef: BuildingDef = {
        ...
        mapObjects: [
            ...
            {
                type: params.specialLoot || "case_08",
...
export const BaseBuildingDefs: Record<string, BuildingDef> = {
    ...
    bathhouse_01: createBathhouse({}),
    bathhouse_sideroom_01: createBathhouseSideroom01({}),
    bathhouse_sideroom_02: createBathhouseSideroom02({}),
    ...
    bridge_xlg_01: createBridgeXlarge({}),
    bridge_xlg_under_01: {
        type: "building",
        map: { display: false },
        terrain: { grass: true, beach: false },
