        ...
        walls: [
            {
                ...
                bounds: [
                    ...
                    {
                        min: v2.create(-9.5, 2.5),
                        max: v2.create(-10.5, 18.5),
                        ori: 1,
                    },
                    {
                        min: v2.create(9.5, 2.5),
                    ...
                    {
                        min: v2.create(-9.5, -22.5),
                        max: v2.create(-10.5, -6.5),
                        ori: 1,
                    },
                    {
                        min: v2.create(4.5, -17.5),
                        max: v2.create(5.5, -11.5),
                        ori: 1,
                    },
                    {
                        min: v2.create(-5, 11),
            ...
            },
            {
                ...
                bounds: [
                    {
                        min: v2.create(-20.5, -2.5),
                        max: v2.create(-21.5, 3.5),
                        ori: 1,
                        img: wallImg("map-wall-06-rounded.img", 0x6d7645),
                    },
                    {
                        min: v2.create(-20.5, -7.5),
                        max: v2.create(-21.5, -1.5),
                        ori: 1,
                        img: wallImg("map-wall-06-rounded.img", 0x6d7645),
                    },
                    {
                    ...
                    {
                        min: v2.create(-12.5, -3.5),
                        max: v2.create(-13.5, -5.5),
                        ori: 1,
                    ...
                    {
                        min: v2.create(16.5, 0.5),
                        max: v2.create(17.5, -3.5),
                        ori: 1,
