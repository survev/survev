import type { Emote } from "@survev/lib/net/updateMsg";
...
import type { AmmoDef } from "@survev/shared/defs/gameObjects/gearDefs";
...
import { EmoteSlot, GameConfig, Input, type TeamMode } from "@survev/shared/gameConfig";
