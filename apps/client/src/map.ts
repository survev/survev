import type { GroundPatch, MapMsg } from "@survev/lib/net/mapMsg";
import { type MapDef, MapDefs } from "@survev/shared/defs/mapDefs";
import { MapObjectDefs } from "@survev/shared/defs/mapObjectDefs";
import type { BuildingDef, ObstacleDef } from "@survev/shared/defs/mapObjectsTyping";
import { GameConfig } from "@survev/shared/gameConfig";
import { type Circle, type Collider, coldet } from "@survev/shared/utils/coldet";
...
import {
    ...
    generateTerrain,
} from "@survev/shared/utils/terrainGen";
