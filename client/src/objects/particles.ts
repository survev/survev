...
const ParticleDefs: Record<string, ParticleDef> = {
    ...
    heal_diamond: createHeal({
        image: ["part-heal-diamond.img"],
    }),
    heal_ankh: createHeal({
        image: ["part-heal-ankh.img"],
        rotVel: new Range(Math.PI * 0.5, Math.PI * 1),
    }),
    heal_menacing: createHeal({
    ...
    boost_club: createBoost({
        image: ["part-boost-club.img"],
    }),
    boost_lightning: createBoost({
        image: ["part-boost-lightning.img"],
    }),
    boost_hermes: createBoost({
        image: ["part-boost-hermes.img"],
    }),
    boost_gearshift_01: createBoost({
        image: ["part-boost-gearshift-01.img"],
        rotVel: 0,
    }),
    boost_gearshift_02: createBoost({
...
const EmitterDefs: Record<string, EmitterDef> = {
    ...
    heal_diamond: createHealEmitter({
        particle: "heal_diamond",
    }),
    heal_ankh: createHealEmitter({
        particle: "heal_ankh",
    }),
    heal_menacing: createHealEmitter({
    ...
    boost_club: createBoostEmitter({
        particle: "boost_club",
    }),
    boost_lightning: createBoostEmitter({
        particle: "boost_lightning",
    }),
    boost_hermes: createBoostEmitter({
        particle: "boost_hermes",
    }),
    boost_gearshift_01: createBoostEmitter({
        particle: "boost_gearshift_01",
        rate: new Range(0.99, 1),
        rot: -(Math.PI * 0.25),
    }),
    boost_gearshift_02: createBoostEmitter({
