                    ...
                    <div id="news-wrapper">
                        ...
                        <div id="news-block" class="menu-block">
                            <div id="news">
                                ...
                                <div id="news-current" data-date="2026-08-24">
                                    <small class="news-date">August 24th, 2026</small>
                                    <p class="news-paragraph"><strong>Classy (or not) Combat</strong></p>
                                    <p class="news-paragraph">
                                        It's time for another round of Project: COBALT! Fight with your favourite class,
                                        such as a now stronger Assault, or drop your class entirely on your quest for
                                        the chicken dinner...
                                    </p>
                                    <p class="news-paragraph">
                                        Additionally, be sure to push for your final cosmetics, as Survevr Pass 1 will
                                        be coming to a close with the next update! If you need a refresher on what the
                                        current pass has in store, be sure to check out the <a
                                            href="https://survev.wiki.gg/wiki/Survevr_Passes#Survevr_Pass_1"
                                        >wiki</a>.
                                    </p>
                                </div>
                                <div data-date="2026-08-09">
                                    <small class="news-date">August 9th, 2026</small>
