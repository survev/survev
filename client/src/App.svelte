<script lang="ts">
    ...
    import "$lib/css/game.css";

    let bg = $state<HTMLDivElement>();

    onMount(() => {
        // Load a cached background image as soon as possible,
        // so that we don't have to wait on API to display a background.
        ...
        import("./main.ts");
        if (import.meta.env.VITE_IS_DEV) import("$lib/css/dev.css");
    });
...
<svelte:head>
    {@html import.meta.env.VITE_TURNSTILE_SCRIPT}
</svelte:head>
...
<div id="game-area-wrapper" style="display: none" oncontextmenu={() => false}>
    ...
    <div id="ui-game" class="click-through">
            ...
            <div id="ui-game-menu">
                <div id="btn-game-tabs" class="btns-game-double-row">
                    <div class="btn-game-container">
                        <a
                            ...
                            class="btn-game-tab-select btn-game-menu btn-game-menu-selected btn-darken"
                            data-tab="settings"
                            aria-label="Settings"
                        ></a>
                    ...
                    <div class="btn-game-container">
                        <a
                            id="btn-game-keybinds"
                            class="btn-game-tab-select btn-game-menu btn-darken"
                            data-tab="keybinds"
                            aria-label="Keybinds"
                        ></a>
                ...
                <div id="ui-game-tab-settings" class="ui-game-tab">
                    <a
                        ...
                        class="btn-fullscreen-toggle btn-game-menu btn-darken"
                        data-l10n="game-full-screen"
                    >Full Screen</a>
                    ...
                    <a id="btn-game-aim-line" class="btn-game-menu btn-darken locked-on-icon" data-l10n="game-aim-line"
                    >Aim Line</a>
                    <a
                        id="btn-game-sound"
                        class="btn-sound-toggle btn-game-menu btn-darken audio-on-icon"
                        data-l10n="game-sound"
                    >Sound</a>
                    ...
                    <a id="btn-game-quit" class="btn-quit btn-game-menu btn-darken" data-l10n="game-quit-game"
                    >Quit Game</a>
                </div>
                <div id="ui-game-tab-keybinds" class="ui-game-tab">
                    <div id="ui-keybind-list" class="js-keybind-list"></div>
                    <a
                        class="js-btn-keybind-restore btn-keybind-restore btn-game-menu btn-darken"
                        data-l10n="game-restore-defaults"
                    >Restore Defaults</a>
                </div>
                <a id="btn-game-resume" class="btn-game-menu btn-darken" data-l10n="game-return-to-game"
                >Return to Game</a>
            </div>
        </div>
        ...
        <div id="ui-emotes" class="ui-emote-wheel">
            <div
                id="ui-emote-middle"
                class="ui-emote-middle ui-emote-circle ui-emote-parent"
                data-key="middle"
                data-id="0"
            >
            ...
            <div
                id="ui-emote-right"
                class="ui-emote-right ui-emote-quarter ui-emote-parent"
                data-key="right"
                data-id="2"
            >
                <div class="ui-emote ui-emote-bg-quarter"></div>
            ...
            <div
                id="ui-emote-bottom"
                class="ui-emote-bottom ui-emote-quarter ui-emote-parent"
                data-key="bottom"
                data-id="3"
            >
                <div class="ui-emote ui-emote-bg-quarter"></div>
            ...
            <div id="ui-medical-interactive">
                <div id="ui-loot-bandage" class="ui-loot ui-outline-hover ui-scale-hover ui-medical tooltip">
                    <div class="tooltip-text">
                        ...
                        <div class="tooltip-description">
                            <span data-l10n="game-bandage-tooltip">Left-click to restore 15 health.</span>
                        </div>
                    </div>
                ...
                <div id="ui-loot-healthkit" class="ui-loot ui-outline-hover ui-scale-hover ui-medical tooltip">
                    <div class="tooltip-text">
                        ...
                        <div class="tooltip-description">
                            <span data-l10n="game-healthkit-tooltip">Left-click to restore 100 health.</span>
                        </div>
                    </div>
                    <div class="ui-loot-count">0</div>
                    <img class="ui-loot-image" src="">
                ...
                <div id="ui-loot-soda" class="ui-loot ui-outline-hover ui-scale-hover ui-medical tooltip">
                    <div class="tooltip-text">
                        ...
                        <div class="tooltip-description">
                            <span data-l10n="game-soda-tooltip">Left-click to boost adrenaline by 25.</span><br><span
                                data-l10n="game-adrenaline-tooltip"
                            >Adrenaline restores health over time.</span>
                        </div>
                    </div>
                    <div class="ui-loot-count">0</div>
                    <img class="ui-loot-image" src="">
                ...
                <div id="ui-loot-painkiller" class="ui-loot ui-outline-hover ui-scale-hover ui-medical tooltip">
                    <div class="tooltip-text">
                        ...
                        <div class="tooltip-description">
                            <span data-l10n="game-painkiller-tooltip">Left-click to boost adrenaline by 50.</span>
                        </div>
                    </div>
                    <div class="ui-loot-count">0</div>
                    <img class="ui-loot-image" src="">
                ...
                <div id="ui-settings-container-mobile" class="js-ui-mobile-map-hidden">
                    <div id="ui-alive-info">
                        ...
                        <div id="ui-map-counter-faction">
                            <span class="ui-players-alive-red js-ui-players-alive-red">0</span>:<span
                                class="ui-players-alive-blue js-ui-players-alive-blue"
                            >0</span>
                        </div>
                    </div>
        ...
        <div id="ui-top-center" class="js-ui-map-hidden js-ui-hud-show click-through">
            <div id="ui-waiting-text" class="top-center-text">
                <span data-l10n="game-waiting-for-players">Waiting for players</span>...
            </div>
        ...
        <div id="ui-spectate-options-wrapper">
            <div id="ui-spectate-options" class="ui-spectate-mode js-ui-hud-show click-through">
                <div id="ui-spectate-buttons" class="ui-bg-standard">
                    <a class="menu-option btn-darken" id="btn-spectate-next-player" data-l10n="game-next-teammate"
                    >Next Teammate</a>
                    <a class="menu-option btn-darken" id="btn-spectate-prev-player" data-l10n="game-previous-teammate"
                    >Previous Teammate</a>
                    <a class="menu-option btn-darken" id="btn-spectate-view-stats" data-l10n="game-view-match-stats"
                    >View Match Stats</a>
                    <a class="menu-option btn-darken btn-quit" id="btn-spectate-quit" data-l10n="game-leave-game"
                    >Leave Game</a>
                </div>
                <div id="ui-spectate-stats" class="ui-bg-standard">
                    ...
                    <table id="ui-spectate-stats-table">
                        <tbody id="ui-spectate-stats-data"></tbody>
                    </table>
                </div>
            </div>
        </div>
    ...
    <div id="ui-editor" style="display: none">
        ...
        <div id="ui-editor-top-right"></div>
    </div>
</div>
<div id="start-menu-wrapper">
    <div id="safari-margin"></div>
    <div id="background" bind:this={bg}>
    ...
    <div id="start-main">
            ...
            <div class="modal-content modal-close">
                ...
                <div class="modal-body modal-body-name">
                    <div class="modal-settings-item">
                        <p id="modal-account-name-desc" class="modal-body-text" data-l10n="index-set-account-name">
                            Set your account name:
                        </p>
                        <div id="modal-body-warning"></div>
                        <input
                            type="text"
                            class="menu-option player-name-input"
                            tabindex="0"
                            data-l10n="index-enter-name"
        ...
        <div id="modal-account-reset-stats" class="modal modal-account">
            <div class="modal-content modal-close">
                ...
                <div class="modal-body modal-body-reset-stats">
                    <div class="modal-settings-item">
                        <p
                            id="modal-account-reset-stats-desc"
                            class="modal-body-text"
                            data-l10n="index-reset-stats-desc"
                        >
                            Enter "RESET STATS" to reset your stats:
                        </p>
                        <p
                            id="modal-account-reset-stats-desc-2"
                            class="modal-body-text"
                            data-l10n="index-reset-stats-desc-2"
                        >
                        ...
                        <input
                            ...
                            tabindex="0"
                            placeholder=""
                            id="modal-account-reset-stats-input"
                            maxlength="16"
                        />
                    </div>
                </div>
        ...
        <div id="modal-account-delete" class="modal modal-account">
            <div class="modal-content modal-close">
                ...
                <div class="modal-body modal-body-delete">
                    <div class="modal-settings-item">
                        <p id="modal-account-delete-desc" class="modal-body-text" data-l10n="index-delete-account-desc">
                ...
                <div id="modal-mobile-account-body">
                    <div class="account-buttons-settings account-buttons-wrapper account-block-arrow modal-close">
                        <div class="account-buttons">
                            <div
                                class="account-stats-link btn-player-stats-link menu-option btn-darken btn-standard"
                            ...
                            -->
                            <div
                                class="btn-account-change-name btn-account-turq menu-option btn-darken btn-standard"
                                data-l10n="index-change-account-name"
                            >
                                Change Account Name
                            </div>
                            <div
                                class="btn-account-reset-stats btn-account-turq menu-option btn-darken btn-standard"
                                data-l10n="index-reset-stats"
                            >
                                Reset Stats
                            </div>
                            <div
                                class="btn-account-delete btn-account-turq menu-option btn-darken btn-standard"
                                data-l10n="index-delete-account"
                            >
                                Delete Account
                            </div>
                            <div
                                class="btn-account-logout btn-account-grey menu-option btn-darken btn-standard"
                                data-l10n="index-log-out"
                            >
                                Log Out
                            </div>
                        </div>
                    ...
                    <div
                        id="account-login-options-mobile"
                        class="account-buttons-link-account account-buttons-wrapper account-block-arrow modal-close"
                    >
                ...
                <div class="account-details-top">
                    <div class="account-details-top-buttons">
                        ...
                        <div class="account-details-button-wrapper account-details-link-out menu-option btn-darken hide-on-mobile">
                            <div class="account-details-button">
                                <div class="account-link account-stats-link">
                                    <span data-l10n="index-my-stats">My Stats</span>
                                </div>
                            </div>
                        </div>
                        <div class="account-details-button-wrapper account-details-link-out menu-option btn-darken hide-on-mobile">
                            <div class="account-details-button">
                                <div class="account-link account-leaderboard-link">
                                    <span data-l10n="index-leaderboards">Leaderboards</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="account-overview">
                    <div class="account-details-user account-details-block">
                        <div class="account-details">
                            ...
                            <div
                                id="account-login"
                                class="account-player-name account-name account-name-user"
                                data-l10n="index-log-in-desc"
                            >
        ...
        <div id="start-main-center">
            ...
            <div id="start-row-top">
                    ...
                    <div id="social-share-block-wrapper">
                        <div id="social-share-block" class="menu-block">
                            <div class="btn-social-wrapper">
                                ...
                                ></a>
                                <a
                                    href="https://survev.wiki.gg/"
                                    target="_blank"
                                    class="btn-social btn-darken btn-wiki"
                                ></a>
                                <!--
                    ...
                    <div class="play-button-container">
                        <div id="player-options">
                            <input
                                ...
                                data-l10n="index-enter-name-here"
                                id="player-name-input-solo"
                                maxlength="16"
                            />
                            <a class="btn-darken menu-option player-options-btn" id="btn-customize"></a>
                        </div>
                        <select
                            id="server-select-main"
                            class="server-select menu-option btn-hollow btn-hollow-selected"
                        >
                            <optgroup id="server-opts" label="Region" data-l10n="index-region"></optgroup>
                        </select>
                        <a class="btn-green btn-darken menu-option" id="btn-start-mode-0" data-l10n="index-play-solo"
                        >Play Solo</a>
                        <div id="btns-quick-start">
                            <a class="btn-green btn-darken menu-option" id="btn-start-mode-1" data-l10n="index-play-duo"
                            >Play Duo</a>
                            <a
                                class="btn-green btn-darken menu-option"
                                id="btn-start-mode-2"
                                data-l10n="index-play-squad"
                            >Play Squad</a>
                        </div>
                        <div class="btns-double-row">
                            <a
                                class="btn-darken menu-option btn-team-option"
                                id="btn-join-team"
                                data-l10n="index-join-team"
                            >Join Team</a>
                            <a
                                class="btn-darken menu-option btn-team-option"
                                id="btn-create-team"
                                data-l10n="index-create-team"
                            >Create Team</a>
                        </div>
                        <div id="btn-help" class="menu-option btn-darken" data-l10n="index-how-to-play">
                            How to Play
                        </div>
                        <div id="start-help">
                            <h1 data-l10n="index-controls">Controls</h1>
                            <p>
                                <span class="help-action" data-l10n="index-movement"></span>: <span
                                    class="help-control"
                                    data-l10n="index-movement-ctrl"
                                ></span>
                            </p>
                            <p>
                                <span class="help-action" data-l10n="index-aim"></span>: <span
                                    class="help-control"
                                    data-l10n="index-aim-ctrl"
                                ></span>
                            </p>
                            <p>
                                <span class="help-action" data-l10n="index-punch"></span>/<span
                                    class="help-action"
                                    data-l10n="index-shoot"
                                ></span>: <span class="help-control" data-l10n="index-shoot-ctrl"></span>
                            </p>
                            <p>
                                <span class="help-action" data-l10n="index-change-weapons"></span>: <span
                                    class="help-control"
                                    data-l10n="index-change-weapons-ctrl"
                                ></span>
                            </p>
                            <p class="hide-on-mobile">
                                <span class="help-action" data-l10n="index-stow-weapons"></span>: <span
                                    class="help-control"
                                    data-l10n="index-stow-weapons-ctrl"
                                ></span>
                            </p>
                            <p class="hide-on-mobile">
                                <span class="help-action" data-l10n="index-swap-weapons"></span>: <span
                                    class="help-control"
                                    data-l10n="index-swap-weapons-ctrl"
                                ></span>
                            </p>
                            <p class="hide-on-mobile">
                                <span class="help-action" data-l10n="index-swap-weapon-slots"></span>: <span
                                    class="help-control"
                                    data-l10n="index-swap-weapon-slots-ctrl"
                                ></span>
                            </p>
                            <p>
                                <span class="help-action" data-l10n="index-reload"></span>: <span
                                    class="help-control"
                                    data-l10n="index-reload-ctrl"
                                ></span>
                            </p>
                            <p>
                                <span class="help-action" data-l10n="index-scope-zoom"></span>: <span
                                    class="help-control"
                                    data-l10n="index-scope-zoom-ctrl"
                                ></span>
                            </p>
                            <p>
                                <span class="help-action" data-l10n="index-pickup"></span>/<span
                                    class="help-action"
                                    data-l10n="index-loot"
                                ></span>/<span class="help-action" data-l10n="index-revive"></span>: <span
                                    class="help-control"
                                    data-l10n="index-pickup-ctrl"
                                ></span>
                            </p>
                            <p>
                                <span class="help-action" data-l10n="index-use-medical"></span>: <span
                                    class="help-control"
                                    data-l10n="index-use-medical-ctrl"
                                ></span>
                            </p>
                            <p>
                                <span class="help-action" data-l10n="index-drop-item"></span>: <span
                                    class="help-control"
                                    data-l10n="index-drop-item-ctrl"
                                ></span>
                            </p>
                            <p>
                                <span class="help-action" data-l10n="index-cancel-action"></span>: <span
                                    class="help-control"
                                    data-l10n="index-cancel-action-ctrl"
                                ></span>
                            </p>
                            <p>
                                <span class="help-action" data-l10n="index-view-map"></span>: <span
                                    class="help-control"
                                    data-l10n="index-view-map-ctrl"
                                ></span>
                            </p>
                            <p class="hide-on-mobile">
                                <span class="help-action" data-l10n="index-toggle-minimap"></span>: <span
                                    class="help-control"
                                    data-l10n="index-toggle-minimap-ctrl"
                                ></span>
                            </p>
                            <p>
                                <span class="help-action" data-l10n="index-use-ping"></span>: <span
                                    class="help-control"
                                    data-l10n="index-use-ping-ctrl"
                                ></span>
                            </p>
                            <p>
                                <span class="help-action" data-l10n="index-use-emote"></span>: <span
                                    class="help-control"
                                    data-l10n="index-use-emote-ctrl"
                                ></span>
                            </p>
                            <h1 data-l10n="index-how-to-play">How to Play</h1>
                            <p data-l10n="index-tips-1-desc">
                                The goal of survev.io is to be the last player standing. You only live once per game -
                                there is no respawn!
                            </p>
                            <h1 data-l10n="index-tips-2">2D PUBG</h1>
                            <p data-l10n="index-tips-2-desc">
                                If you've played other battle royale games like PUBG, Fortnite or H1Z1, then you're
                                already halfway there! Think of survev.io as 2D PUBG (with slightly less desync and more
                                chicken).
                            </p>
                            <h1 data-l10n="index-tips-3">Loot and Kill</h1>
                            <p data-l10n="index-tips-3-desc">
                                You'll begin the game with no items other than a simple backpack. Move around the map to
                                find loot: weapons, ammo, scopes, and medical items. Eliminate other players and you can
                                take their loot!
                            </p>
                            <h1 data-l10n="index-tips-4">Red = Bad!</h1>
                            <p data-l10n="index-tips-4-desc">
                                Players aren't the only thing that can hurt you. The deadly red zone will move in from
                                the sides of the map and deal increasingly greater damage if you stand in it. Keep an
                ...
                <div id="team-menu" class="menu-column menu-block">
                    ...
                    <div class="play-button-container">
                        <a class="btn-darken menu-option" id="btn-team-leave" data-l10n="index-leave-team"
                        >Leave Team</a>
                        <div id="team-menu-connecting">
                            <div class="ui-spinner"></div>
                            <div class="team-menu-connecting-text" id="team-menu-joining-text">
                                <span data-l10n="index-joining-team">Joining team</span> ...
                            </div>
                            <div class="team-menu-connecting-text" id="team-menu-creating-text">
                                <span data-l10n="index-creating-team">Creating team</span> ...
                            </div>
                        </div>
                        <div id="team-menu-contents">
                            <div id="team-desc">
                                <div id="team-desc-text">
                                    <span id="invite-link-text" data-l10n="index-invite-link">Invite link</span>: <span
                                        id="team-url"
                                    ></span>
                                </div>
                                <a id="team-copy-url" class="copy-item btn-darken"></a>
                                <a id="team-hide-url" class="hide-item btn-darken"></a>
                                <div id="team-code-text">
                                    <span id="invite-code-text" data-l10n="index-invite-code">Invite code</span>: <span
                                        id="team-code"
                                    ></span>
                                </div>
                            </div>
                            <div id="team-menu-columns">
                                ...
                                <div id="team-menu-options" class="team-menu-block">
                                    <select
                                        id="team-server-select"
                                        class="btn-hollow btn-hollow-selected server-select menu-option"
                                    >
                                        <optgroup id="team-server-opts" label="Region"></optgroup>
                                    </select>
                                    <div class="team-menu-options-buttons">
                                        <a
                                            class="btn-hollow btn-hollow-selected btn-darken team-menu-option btn-team-queue"
                                            id="btn-team-queue-mode-1"
                                            data-l10n="index-duo"
                                        >Duo</a>
                                        <a
                                            class="btn-hollow btn-hollow-selected btn-darken team-menu-option btn-team-queue"
                                            id="btn-team-queue-mode-2"
                                            data-l10n="index-squad"
                                        >Squad</a>
                                    </div>
                                    <div class="team-menu-options-buttons">
                                        <a
                                            class="btn-hollow btn-hollow-selected btn-darken team-menu-option btn-team-fill"
                                            id="btn-team-fill-auto"
                                            data-l10n="index-auto-fill"
                                        >Auto Fill</a>
                                        <a
                                            class="btn-hollow btn-darken team-menu-option btn-team-fill"
                                            id="btn-team-fill-none"
                                            data-l10n="index-no-fill"
                                        >No Fill</a>
                                    </div>
                ...
                <div id="team-mobile-link" class="menu-column menu-block">
                    <div id="team-mobile-link-desc" class="team-mobile-link-text" data-l10n="index-join-team-help">
                    ...
                    <input
                        ...
                        tabindex="0"
                        autofocus
                        placeholder="Paste team link or enter code here"
                        id="team-link-input"
                    />
                    <a
                        class="btn-darken menu-option btn-team-option"
                        id="btn-team-mobile-link-join"
                        data-l10n="index-join-team"
                    >Join Team</a>
                    <a class="btn-darken menu-option" id="btn-team-mobile-link-leave" data-l10n="index-back-to-main"
                    >Back to Main Menu</a>
                </div>
                        ...
                        <div id="pass-block" class="pass-column menu-block">
                            ...
                            <div id="pass-quest-wrapper" class="">
                                <div id="pass-locked">
                                    <div
                                        id="btn-pass-locked"
                                        class="menu-option btn-darken"
                                        data-l10n="quest-login-prompt"
                                    >
                                        Log in to get quests!
                                    </div>
                                </div>
                                <div id="pass-quest-0" class="pass-quest">
                                    ...
                                    <div class="pass-quest-refresh-prompt">
                                        <div class="pass-quest-refresh-prompt-text" data-l10n="quest-refresh-prompt">
                                            Get a new quest?
                                        </div>
                    ...
                    <div id="news-wrapper">
                        ...
                        <div id="news-block" class="menu-block">
                            <div id="news">
                                ...
                                <div id="news-current" data-date="2026-08-08">
                                    <small class="news-date">August 8th, 2026</small>
                                    <p class="news-paragraph"><strong>Summer Breeze</strong></p>
                                    <p class="news-paragraph">
                                        After a harsh stretch of airstrikes and summer heat, the foliage has risen and
                                        <span class="highlight">Woods</span> has returned to the island! Rush to grab
                                        some devastating 12 guage weapons or crown some new kings.
                                    </p>
                                    <p class="news-paragraph">
                                        For those who want to get up to speed with the latest leeks, news, and updates,
                                        be sure to check out our <a href="https://discord.gg/75RAK3p3K2"
                                        >Discord Server</a>! or our <a href="https://survev.wiki.gg">wiki</a>!
                                    </p>
                                </div>
                                <div data-date="2026-07-15">
                                    <small class="news-date">July 15th, 2026</small>
                                    <p class="news-paragraph"><strong>Breaking the Bank</strong></p>
                                    <p class="news-paragraph">
                                        As the island aridifies, enterprising survevrs may notice that a new monetary
                                        institution has risen out of the sands: <span class="highlight"
                                        >The Reserve</span>. A massive bank constructed to hide PARMA's best kept
                                        secrets, the vault is rumoured to contain exotic and powerful weaponry.
                                    </p>
                                    <p class="news-paragraph">
                                        For survevrs trudging through the desert heat, find respite, resources, and
                                        fresh water in the <span class="highlight">oasis</span>. Or, join the hunt for
                                        the last supplies sent to the front during the Incursion, and try to find out
                                        why a familiar club's insignia keeps on appearing on these damn airdrops...
                                    </p>
                                    <p class="news-paragraph">
                                        Of course, no bank heist is complete without big guns. The Department of
                                        Advanced Weaponry's newest hat trick of the <span class="highlight"
                                        >S&W 500</span> revolver, the <span class="highlight">ASh-12</span> assault
                                        rifle, and the <span class="highlight">Barrett M107</span> anti-materiel rifle
                                        are all capable of dishing out massive damage, but be sure to conserve your
                                        precious .50 cal ammo.
                                    </p>
                                </div>
                                <div data-date="2026-06-19">
                                    <small class="news-date">June 19th, 2026</small>
                                    <p class="news-paragraph"><strong>The Eleventh Hour</strong></p>
                                    <p class="news-paragraph">
                                        As we continue to work on our next big update, enjoy another round of 50v50
                                        along with a requested change: Lone Survevrs can now ping all allies, regardless
                                        of their original squads!
                                    </p>
                                </div>
                                <div data-date="2026-06-01">
                                    <small class="news-date">June 1st, 2026</small>
                                    <p class="news-paragraph"><strong>Tuber Trouble</strong></p>
                                    <p class="news-paragraph">
                                        With the augmenting vats having exhausted PARMA's reasources, focus has shifted
                                        to the FSTMS division and further testing of the PMG-134.
                                    </p>
                                    <p class="news-paragraph">
                                        Our next large update is making steady progress; for all the latest leeks, be
                                        sure to join our <a href="https://discord.gg/75RAK3p3K2">Discord Server</a>!
                                    </p>
                                </div>
                                <div data-date="2026-05-11">
                                    ...
                                    <p class="news-paragraph">
                                        Before the Soviet incursion and brutal fighting that ensued, PARMA scientists
                                        were given a directive: create the strongest survevr they possibly could. Their
                                        work now lies deep within the Twins...
                                    </p>
                                    <p class="news-paragraph">
                                        Project: COBALT has returned! Along with much-needed adjustments for the Medic
                                        and Demo classes, PARMA is proud to announce a new perk: <span class="highlight"
                                        >Indomitable Spirit</span>, allowing survevrs to shrug off fatal injuries
                                        through (quite literally) pure adrenaline.
                                    </p>
                                    <p class="news-paragraph">
                                        Additionally, the long-anticipated <span class="highlight">Survevr Pass 1</span>
                                        has arrived, allowing you to flex your style with over 20 different cosmetics!
                                        The pass is completely <span class="highlight">free</span>; just <span
                                            class="highlight"
                                        >log in</span> and complete two quests per day! If you don't like a quest, you
                                        can refresh it for a new one.
                                    </p>
                                </div>
                                <div data-date="2026-04-13">
                                    ...
                                    <p class="news-paragraph">
                                        As both sides exhaust their nightshade and weapon supplies, the Island rests
                                        again... what could have prompted such fierce fighting?
                                    </p>
                                    <p class="news-paragraph">
                                        Over the past couple of years, PARMA has relied on third-party archives to train
                                        newbie survevrs, many of which were either misleading or hard to navigate. We've
                                        taken matters into our own hands and begun developing a comprehensive guide: the
                                        <a href="https://survev.wiki.gg">Survev.io Wiki</a>!
                                    </p>
                                    <p class="news-paragraph">
                                        However, many of the sections are still yet to be filled, so we're welcoming our
                                        veterans to help contribute! For easier communication between survevrs, be sure
                                        to join the <a href="https://discord.gg/75RAK3p3K2">Discord Server</a>!
                                    </p>
                                </div>
                                <div data-date="2026-04-01">
                                    ...
                                    <p class="news-paragraph">
                                        While survevrs have since become accustomed to the periodical spuddy incursions
                                        on the island, life was not always this way. Once, botanist brothers Spud and
                                        Percy Solanum worked in tandem, seeking to uncover the mysteries of the <span
                                            class="highlight"
                                        >[REDACTED]</span>. In an act of betrayal, the Soviets obtained their precious
                                        research secrets, fragmenting their partnership forever. Join the fight of
                                        potato vs <span class="highlight">tomato</span>... and may the best nightshade
                                        win!
                                    </p>
                                    <p class="news-paragraph">
                                        Additionally, PARMA's FSTMS division is proud to present their latest
                                        concoction: the <span class="highlight">PMG-134</span> (Potato Minigun 134),
                                        using a six-barrel rotary machine gun to blast tater tots at insane firerates.
                                        It's perfect for mowing down your local Soviet!
                                    </p>
                                </div>
                                <div data-date="2026-03-24">
                                    ...
                                    <p class="news-paragraph">
                                        As PARMA continues to work on their research, the snow has melted and spring has
                                        returned to the island! Enjoy the cherry blossoms!
                                    </p>
                                    <p class="news-paragraph">
                                        For the latest leeks and developments, be sure to join the <a
                                            href="https://discord.gg/75RAK3p3K2"
                                        >Discord Server</a>!
                                    </p>
                                </div>
                                <div data-date="2026-03-09">
                                    ...
                                    <p class="news-paragraph">
                                        As we head into the final stretch of winter, our favourite arboreal mode has
                                        returned with a fresh coat of snow! For those who have been fighting through the
                                        winter weather, seek refuge at the <span class="highlight">campfires</span>
                                        spread out across the island.
                                    </p>
                                    <p class="news-paragraph">
                                        In addition, PARMA's Department of Advanced Weaponry would be proud to present
                                        the new <span class="highlight">SPAS-16</span>, capable of unloading heavy
                                        damage... if they could find where their prototype went, that is.
                                    </p>
                                    <p class="news-paragraph">
                                        The standard-issue <span class="highlight">IMD-2</span> is great for surpressing
                                        enemies with its high fire rate, but will have you asking your squad for ammo
                                        more often than not.
                                    </p>
                                    <p class="news-paragraph">
                                        As PARMA attempts to defrost their simulation equipment, those who persist will
                                        be rewarded with the first blossoms of spring.
                                    </p>
                                </div>
                                <div data-date="2026-02-02">
                                    ...
                                    <p class="news-paragraph">
                                        A new structure, lootable perks, and an open map: welcome back to the Savannah
                                        hallucination! For the brave, the bold, and the bloodthirsty, a secondary 'perk'
                                        is given to the kill leader: <span class="highlight">The Hunted</span>,
                                        revealing your position to all enemies.
                                    </p>
                                    <p class="news-paragraph">
                                        Ever wanted your bullets to travel at absurd speeds? Look no further than
                                        PARMA's new perk: <span class="highlight">High-Velocity Rounds</span>! This perk
                                        greatly increases bullet speed & range.
                                    </p>
                                    <p class="news-paragraph">
                                        Additionally, a new <span class="highlight">warehouse</span> has been
                                        constructed, offering a more <span><s>dangerous</s></span> secure place to store
                                        valuables, such as the new <span class="highlight">construction case</span>.
                                    </p>
                                    <p class="news-paragraph">
                                        If you need hunting partners, look no further than our <a
                                            href="https://discord.gg/75RAK3p3K2"
                                        >Discord Server</a>!
                                    </p>
                                </div>
                                <div data-date="2026-01-18">
                                    ...
                                    <p class="news-paragraph">
                                        Tired of the snow and ice? PARMA is providing a limited-time opportunity for
                                        Survevrs to escape... to a tropical island! Grab a <span class="highlight"
                                        >Coconut</span> from the swaying <span class="highlight">Palm Trees</span> and
                                        throw it at a friend or foe, or set sail for the new <span class="highlight"
                                        >Pirate Hut</span> to obtain the mythical <span class="highlight"
                                        >Golden Cutlass</span>. Legend says those who wield the sword will never fail to
                                        find bountiful loot with each enemy they slay.
                                    </p>
                                    <p class="news-paragraph">
                                        Surprises also await those who choose to tough out the winter weather. Trudge
                                        through the snow to find an <span class="highlight">Iced Hardstone Block</span>,
                                        which can only be broken by the new <span class="highlight">Ice Axe</span>.
                                        Enjoy some gun model redesigns and Winter recolors, some minor balance
                                        adjustments, and a plethora of bugfixes and improvements!
                                    </p>
                                    <p class="news-paragraph">
                                        For an exclusive look at what's happening on the island, and to connect with the
                                        player community, check out our <a href="https://discord.gg/75RAK3p3K2"
                                        >Discord Server!</a>!
                                    </p>
                                </div>
                            </div>
        ...
        <div id="start-bottom-middle">
            <a href="changelogRec.html" target="_blank" class="footer-after">ver {import.meta.env.VITE_GAME_VERSION}</a>
            <a href="changelog.html" target="_blank" data-l10n="index-original-changelog">Original changelog</a>
            <!--
        ...
        <div id="start-bottom-right-wrapper">
            <div id="start-bottom-right">
                ...
                <div
                    ...
                    class="btn-fullscreen-toggle menu-option btn-darken btn-start-option"
                ></div>
    ...
    <!-- Modals -->
    <div id="ui-modal-keybind" class="ui-modal-keybind modal" oncontextmenu={() => false}>
        <div class="ui-modal-keybind-content modal-content modal-close">
            ...
            <div id="ui-modal-keybind-body" class="modal-body">
                ...
                <div id="ui-modal-keybind-share">
                    ...
                    <span class="keybind-share-paste-text" data-l10n="index-keybind-paste"
                    >Load keybinds using a code here</span><span>:</span>
                    ...
                    <div class="ui-modal-keybind-share-row">
                        <input
                            ...
                            tabindex="0"
                            autofocus
                            placeholder="Paste a keybind code here"
                            id="keybind-code-input"
                        />
                        <a class="btn-game-menu btn-darken" id="btn-keybind-code-load" data-l10n="index-keybind-apply"
                        >Load</a>
                    </div>
                </div>
            </div>
            <div id="ui-modal-keybind-footer" class="modal-footer modal-footer-round">
                ...
                <a class="js-btn-keybind-restore btn-game-menu btn-darken" data-l10n="game-restore-defaults"
                >Restore Defaults</a>
            </div>
        </div>
    </div>
            ...
            <div id="modal-content-right-emote" class="modal-content-right modal-content-shadow">
                <div id="customize-emote-parent">
                    <div id="customize-emote-wheel" class="ui-emote-wheel">
                        ...
                        <div
                            id="customize-emote-top"
                            class="ui-emote-top ui-emote-quarter ui-emote-parent"
                            data-slot="emoteTop"
                            data-idx="0"
                        >
                            <div class="ui-emote ui-emote-bg-quarter"></div>
                        ...
                        <div
                            id="customize-emote-right"
                            class="ui-emote-right ui-emote-quarter ui-emote-parent"
                            data-slot="emoteRight"
                            data-idx="1"
                        >
                            <div class="ui-emote ui-emote-bg-quarter"></div>
                            <div class="ui-emote ui-emote-hl"></div>
                        ...
                        <div
                            id="customize-emote-bottom"
                            class="ui-emote-bottom ui-emote-quarter ui-emote-parent"
                            data-slot="emoteBottom"
                            data-idx="2"
                        >
                            <div class="ui-emote ui-emote-bg-quarter"></div>
                            <div class="ui-emote ui-emote-hl"></div>
                        ...
                        <div
                            id="customize-emote-left"
                            class="ui-emote-left ui-emote-quarter ui-emote-parent"
                            data-slot="emoteLeft"
                            data-idx="3"
                        >
                            <div class="ui-emote ui-emote-bg-quarter"></div>
                    ...
                    <div id="customize-emote-autos">
                        ...
                        <div
                            id="customize-emote-death"
                            class="ui-emote-middle ui-emote-circle ui-emote-parent"
                            data-slot="emoteDeath"
                            data-idx="5"
                        >
                            <div class="ui-emote ui-emote-auto-trash"></div>
        ...
        <div class="modal-content modal-close">
            ...
            <div id="modal-settings-body" class="modal-body">
                ...
                <div id="modal-settings-high-res" class="modal-settings-item">
                    <input id="highResTex" type="checkbox"><p
                        class="modal-settings-checkbox-text"
                        data-l10n="index-high-resolution"
                    >
                        High resolution (check to increase visual quality)
                    </p>
                </div>
                <div id="modal-settings-interp" class="modal-settings-item">
                    <input id="interpolation" type="checkbox"><p
                        class="modal-settings-checkbox-text"
                        data-l10n="index-client-side-interp"
                    >
                        Client side interpolation
                    </p>
                </div>
                <div id="modal-settings-rotation" class="modal-settings-item hide-on-mobile">
                    <input id="localRotation" type="checkbox"><p
                        class="modal-settings-checkbox-text"
                        data-l10n="index-client-side-rotation"
                    >
                        Client side player rotation
                    </p>
                </div>
                <div class="modal-settings-item hide-on-mobile">
                    <input id="screenShake" type="checkbox"><p
                        class="modal-settings-checkbox-text"
                        data-l10n="index-screen-shake"
                    >
                        Screen shake
                    </p>
                </div>
                <div class="modal-settings-item">
                    <input id="anonPlayerNames" type="checkbox"><p
                        class="modal-settings-checkbox-text"
                        data-l10n="index-anon-player-names"
                    >
                ...
                <div id="settings-links">
                    ...
                    -->
                    <a href="attribution.txt" target="_blank" class="footer-after" data-l10n="index-attributions"
                    >attributions</a>
            ...
            <div id="modal-hamburger-body" class="modal-body">
                <div id="modal-hamburger-leaderboards">
                    <a
                        href="/stats"
                        target="_blank"
                        class="btn-leaderboard-stats-link menu-option btn-darken"
        ...
        <div class="modal-content modal-close">
            ...
            <div class="modal-body">
                <p class="modal-body-text">
                    A new version of survev.io is available!<br><br>Press "OK" below to reload the page.
                </p>
            </div>
            <div class="modal-footer modal-footer-round">
        ...
        <div id="modal-item-confirm" class="modal">
            <div class="modal-content modal-close">
                ...
                <div class="modal-footer modal-footer-name modal-footer-round">
                    ...
                    <h3 class="close close-footer" data-l10n="index-confirm-all" data-confirm-all="true">
                        Confirm All
                    </h3>
                </div>
            </div>
